...
74241
a:1:{i:0;a:11:{s:8:"style_id";s:1:"2";s:8:"theme_id";s:1:"2";s:10:"theme_data";s:73833:"/*  phpBB 3.0 Style Sheet
    --------------------------------------------------------------
...
! note that -moz-/-web- border radius is browser related so do not delete this thinking the css is not valid in the stylesheet !
---------------------------------------- */
...
/* fix suggested by phpbb styles team for html wrap in IE6 */
* html #wrap {
    width: 900px;
}
/*  	
...
.forabg, .forumbg {
	background-color: #000000;
	background-image: url("{T_THEME_PATH}/images/kop.png");
	background-repeat: no-repeat;
	background-position:top center;
	border: solid 1px #2f3132;
    -moz-border-radius: 2px;
    -webkit-border-radius: 2px;
}
...
.online {
    background-image: url("{T_IMAGESET_PATH}/icon_user_online.png");
   
}

.offline {
    background-image: url("{T_IMAGESET_PATH}/icon_user_offline.png");
} 
...
.menu li a:hover {
	background:  url("{T_THEME_PATH}/images/seporator.png");
	background-repeat: no-repeat;
	background-position:top center;
	color: #808080;
	text-decoration: underline;
...
.search input.box {
	...
	height: 30px;
	padding: 8px 5px 0;
	background:  url("{T_IMAGESET_LANG_PATH}/search_bg.png") no-repeat;
	margin-right: 5px;
}
.search input.box:focus {
	background:  url("{T_IMAGESET_LANG_PATH}/search_bg.png") no-repeat left -38px;
	outline: none;
}
.search button.btn {
	width: 38px;
	height: 38px;
	cursor: pointer;
	background:  url("{T_IMAGESET_LANG_PATH}/search_bg.png") no-repeat top right;
}
.search button.btn:hover {
	background:  url("{T_IMAGESET_LANG_PATH}/search_bg.png") no-repeat bottom right;
}
";s:10:"theme_path";s:11:"GlossyBlack";s:10:"theme_name";s:11:"GlossyBlack";s:11:"theme_mtime";s:10:"1258375234";s:11:"imageset_id";s:1:"2";s:13:"imageset_name";s:11:"GlossyBlack";s:18:"imageset_copyright";s:24:"&copy; phpBB Group, 2007";s:13:"imageset_path";s:11:"GlossyBlack";s:13:"template_path";s:11:"GlossyBlack";}}