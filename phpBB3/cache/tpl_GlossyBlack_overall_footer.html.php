...
//-->
	...
	<br />Design <strong>Glossy black</strong> by <a href="http://phpbbandbbcodes.com/index.php" title="Visit phpbb and bbcodes.com"><strong>phpBB and BBcodes.com</strong></a> &copy; MX
		<?php if ($this->_rootref['TRANSLATION_INFO']) {  ?><br /><?php echo (isset($this->_rootref['TRANSLATION_INFO'])) ? $this->_rootref['TRANSLATION_INFO'] : ''; } if ($this->_rootref['DEBUG_OUTPUT']) {  ?><br /><?php echo (isset($this->_rootref['DEBUG_OUTPUT'])) ? $this->_rootref['DEBUG_OUTPUT'] : ''; } ?><br />
